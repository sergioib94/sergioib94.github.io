...
1. Instalamos los siguientes paquetes para el uso de docker:
...
1. Añadimos la clave gpg a nuestro repositorio (en este caso repositorios de debian):

<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> sudo usermod -aG docker $USER </code>
</pre>
</div>

1. Configuramos el repositorio estable de docker:
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker run "nombre de la imagen" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker run "nombre de la imagen":"version" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker run -d "nombre de la imagen" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker pull "nombre de la imagen" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker images </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker ps </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker stop "ID del contenedor" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker attach "ID contenedor" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker inspect "ID del conetedor" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker kill "ID controlador" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker pause "ID controlador" / docker unpause "ID controlador" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker port "numero de puerto" "ID contenedor" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker -p "nuemro de puerto" "ID contenedor" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker renamo "ID contenedor" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker rm -f $(docker ps -a -q) </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker --version </code>
</pre>
</div>
...
1. Realizamos algun tipo de modificacion:
1. Usamos el comando docker commit para crear una imagen que contenga la imagen base usasda + las modificaciones añadidas:
...
1. Una vez logueados ejecutamos docker push subiendo nuestra imagen a docker hub.
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker network connect/disconnect "ID red" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker network create </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker network inspect "ID red" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker network ls </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker network rm </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker volume create "nombre del volumen" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker volume rm "nombre del volumen" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker volume ls </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker volume prune </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> docker volume inspect "nombre del volumen" </code>
</pre>
</div>
...
<div class="highlight">
<pre class="chroma">
<code class="language-bash" data-lang="bash"> Inicio > Configuración > Aplicaciones > Características Opcionales </code>
</pre>
</div>
